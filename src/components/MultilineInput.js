...
const MultilineInput = ({
    ...
    if (value === '' && placeholder) {
        return React.createElement(Box, null,
            ...
            showCursor && isActive && React.createElement(Text, { color: 'gray' }, '█')
        );
    }
        ...
        ...lines.map((line, index) =>
            React.createElement(Box, { key: index },
                index === 0 ?
                    ...
                    [
                        React.createElement(Text, { key: 'prompt', color: 'green', bold: true }, prompt + ' '),
                ...
                index === lines.length - 1 && showCursor && isActive &&
