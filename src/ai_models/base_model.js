...
export default class BaseAIModel {
  ...
  async initialize() {
    throw new Error(
      'Método initialize() deve ser implementado pela classe filha',
    );
  }
  ...
  async analyzeCommand(commandData) {
    throw new Error(
      'Método analyzeCommand() deve ser implementado pela classe filha',
    );
  }
  ...
  async askCommand(question, systemContext) {
    throw new Error(
      'Método askCommand() deve ser implementado pela classe filha',
    );
  }
  ...
  getProviderName() {
    throw new Error(
      'Método getProviderName() deve ser implementado pela classe filha',
    );
  }
  ...
  getModelName() {
    throw new Error(
      'Método getModelName() deve ser implementado pela classe filha',
    );
  }
  ...
  async validateApiKey() {
    throw new Error(
      'Método validateApiKey() deve ser implementado pela classe filha',
    );
  }
